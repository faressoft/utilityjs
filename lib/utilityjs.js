...
;(function(root, factory) {
  ...
  /**
   * Check if a giving value is a plain object
   *
  ...
  function isPlainObject(value) {
    return !u.isNull(value) && typeof value === 'object' && value.constructor == Object;
  }
  ...
  /**
   * Change the first character in a string to a lowercase
   * 
   * @param  {String} string the string
   * @return {String}
   */
  function lCFirst(string) {
    ...
    // Split characters
    string = u.explode('', string);

    // Change the case of the first character
    string[0] = string[0].toLowerCase();

    // Join and return the string
    return u.implode('', string);

  }

  /**
   * Change the first character in a string to a uppercase
   * 
   * @param  {String} string the string
   * @return {String}
   */
  ...
  /**
   * Change the first character of each word in a string to a uppercase
   * 
   * @param  {String} string    the string
   * @param  {String} delimiter the seperator characters
   * @return {String}
   */
  function uCWords(string, delimiter) {
    ...
    for (var i = 1; i < string.length; i++) {
      ...
      // Check if the current charcter is one of the delimiter characters
      if (delimiter.indexOf(string[i]) !== -1 && i + 1 < string.length) {
  ...
  u.is_plain_object = u.isPlainObject;
  ...
  u.strtolower      = u.strToLower;
  u.strtoupper      = u.strToUpper;
  u.lcfirst         = u.lCFirst;
  u.ucfirst         = u.uCFirst;
  u.ucwords         = u.uCWords;
